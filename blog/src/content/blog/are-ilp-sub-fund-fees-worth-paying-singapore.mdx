...
<TldrAccordion badge="TL;DR" title="The key takeaways (1 min read)" tone="orange">
  ...
  <p>If it is basically an index fund inside an insurance wrapper, the main question is whether the extra fees are buying you anything meaningful.</p>
  <p>If you are getting similar market exposure for a much higher fee, it is usually worth pausing and asking what the extra cost is doing for you.</p>
</TldrAccordion>
...
## When the fee case is often weaker
