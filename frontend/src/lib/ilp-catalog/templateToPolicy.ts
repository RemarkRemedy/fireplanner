...
export function templateVariantToPolicySeed(
  ...
  return ilpPolicySeedSchema.parse({
    ...
    catalogSource: {
      ...
      paymentStructure: variant.paymentStructure,
      premiumPaymentTermYears: variant.premiumPaymentTermYears,
      policyTermYears: variant.policyTermYears,
      flexiTerm: variant.flexiTerm,
      contributionMode: variant.contributionMode,
