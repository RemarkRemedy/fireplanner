...
- Current live cursor:
  - Current-State Reconstruction override note:
    ...
    - adjacent tempting candidates remain screened:
      ...
      - `AIA Platinum Wealth Legacy` is the next adjacent current protection seam because its TI-after-death residual snapshot should likely be treated the same way as `AIA Platinum Wealth Elite 2.0`, but it still depends on manual current amount owing and current No Lapse Privilege mode
