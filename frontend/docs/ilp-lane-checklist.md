...
- Current live cursor:
  - Fee dashboard stream:
    ...
    - the next live cursor for product coverage is post-Phase-0 family packets, starting with the first honest `After PR 2a` corridor packet rather than reopening audit-only or sub-fund work
