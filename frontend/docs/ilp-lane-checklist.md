...
- Current live cursor:
  - Fee dashboard stream:
    ...
    - the next live cursor for product coverage is `T3` rather than reopening audit-only, blog, sub-fund, single-pay, brochure-only `HSBC Wealth Focus` gaps, or jumping ahead to the heavier `15..30` Tokio families before the cheaper `5..25` seams
