...
- Current live cursor:
  - Fee dashboard stream:
    ...
    - the next live cursor for product coverage is the next honest post-Phase-0 family packet after `E1` and `E2`, rather than reopening audit-only or sub-fund work
