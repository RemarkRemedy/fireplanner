...
- Current live cursor:
  - Fee dashboard stream:
    ...
    - the next live cursor for product coverage is `H1` (`HSBC Wealth Focus` Flexi 2 / Flexi 4) rather than reopening audit-only, blog, sub-fund, single-pay, or repo-wide fixture-refresh work
