...
- Current live cursor:
  - Fee dashboard stream:
    ...
    - the next live cursor for product coverage is the next honest post-Phase-0 family packet after `E1`, `E2`, and `A3`, rather than reopening audit-only or sub-fund work
