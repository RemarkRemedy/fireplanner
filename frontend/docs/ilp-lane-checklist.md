...
- Current live cursor:
  - Fee dashboard stream:
    ...
    - the next live cursor for product coverage is `T1` rather than reopening audit-only, blog, sub-fund, single-pay, brochure-only `HSBC Wealth Focus` gaps, or repo-wide fixture-refresh work
