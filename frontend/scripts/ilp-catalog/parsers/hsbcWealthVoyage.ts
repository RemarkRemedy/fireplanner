...
function buildVariant(document: ExtractedPdfDocument, currency: 'SGD' | 'USD', mipLength: VoyageMip): IlpTemplateVariant {
  ...
  const bonuses: IlpTemplateBonus[] = [
    ...
    ...POWER_UP_BANDS[mipLength].map<IlpTemplateBonus>((band, index) => ({
      ...
      notes: [
        ...
        'Full repayment of missed premiums can reinstate the published missed Power-up Bonus after the modeled missed-AMF deduction.',
      ],
  ...
  const eventChargeRules: IlpTemplateEventChargeRule[] = [
    ...
    },
    {
      ...
      label: 'Missed AMF on Repaid Premiums',
      trigger: 'premium-holiday-repayment',
      ...
      allocation: 'equal-split',
      notes: [
        'When missed premiums are repaid after a premium holiday, the missed AMF is deducted from the repaid regular premium amount before allocation.',
      ],
  ...
  return {
    ...
    scheduledPayoutSupport: {
      ...
      minimumStartPolicyYear: mipLength + 1,
