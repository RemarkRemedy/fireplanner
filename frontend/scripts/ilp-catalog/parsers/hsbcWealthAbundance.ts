...
export function parseHsbcWealthAbundance(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    warnings: [
      ...
      'V1 assumes dividend-paying funds reinvest by default. Cash dividend payout election remains metadata-only and is not reflected in projected policy values.',
