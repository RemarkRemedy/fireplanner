...
function buildVariant(document: ExtractedPdfDocument, term: MipTerm): IlpTemplateVariant {
  ...
  return {
    ...
    warnings: [
      'Invest Flex is modeled as a partial subset in V1. The parser captures the policy fee, regular-premium allocation uplifts, first-year investment bonus, annual loyalty bonus, top-up routing, premium holiday charge, partial-withdrawal charge, and surrender-charge schedules.',
      'Death/TI insurance cover charges, secondary insured option, life-events withdrawal benefit, future premium option, and distribution payout election remain informational only in V1.',
    ],
    unsupportedItems: [
      ...
      'Distribution payout election remains informational only.',
...
export function parseIncomeInvestFlex(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    metadataOnlyBehaviors: [
      ...
      'income-vs1-distribution-payout-election',
    ],
    warnings: [
      'Invest Flex is currently cataloged as a partial product. The regular-premium fee, charge, and bonus path is modeled, but insurance-cover charges, insured-replacement / life-event options, and distribution payout elections remain informational only.',
    ],
    archived: false,
