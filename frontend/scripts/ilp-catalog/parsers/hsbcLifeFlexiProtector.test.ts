...
describe('parseHsbcLifeFlexiProtector', () => {
  it('builds a valid supported HSBC Life Flexi Protector product from the source PDF', async () => {
    ...
    expect(product.metadataOnlyBehaviors).not.toContain('hsbc-life-flexi-protector-tpd-payout-structure')
    expect(product.metadataOnlyBehaviors).not.toContain('hsbc-life-flexi-protector-premium-holiday-lapse-sequencing')
    expect(product.metadataOnlyBehaviors).not.toContain('hsbc-life-flexi-protector-policy-change-approvals')
    expect(product.metadataOnlyBehaviors).not.toContain('hsbc-life-flexi-protector-usd-corridor')
