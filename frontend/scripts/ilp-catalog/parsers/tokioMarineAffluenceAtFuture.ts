...
function buildVariant(document: ExtractedPdfDocument): IlpTemplateVariant {
  ...
  const page12 = sourceRef(12, 'Partial Withdrawal and Regular Withdrawal Charge', snippetNear(document, 12, 'Partial Withdrawal and Regular Withdrawal Charge', 12))
  ...
  return {
    ...
    warnings: [
      ...
      'This partial template models 24-month initial-versus-accumulation routing, the published initial bonus tiers, the year-scaled initial charge schedule with the policy-year-10 cap, the policy charge premium-base multiplier basis, top-up routing, recurring single premium routing, nil partial-withdrawal charge, and the published 15-year surrender charge table.',
    ...
    unsupportedItems: [
      ...
      'Monthly protection charge, advanced death benefit, life benefit rider, multiple-life handling, and change-of-life-assured administration remain metadata-only for this product.',
      'Dividend distribution election, regular withdrawal, partial-withdrawal minimum-account-value constraints, premium holiday state handling, and non-SGD or non-25-year variants remain metadata-only for this product.',
    ],
    sourceRefs: [page1, page2, page5, page6, page8, page10, page11, page12, page18],
  }
}
...
export function parseTokioMarineAffluenceAtFuture(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    metadataOnlyBehaviors: [
      ...
      'tokio-affluence-atfuture-advanced-death-benefit-and-monthly-protection-charge',
      'tokio-affluence-atfuture-dividend-distribution-regular-withdrawal-and-partial-withdrawal-constraints',
    ...
    warnings: [
      ...
      'Initial charge is modeled through the published year-scaled account-value fee schedule on the Initial Units Account with the term-minus-five cap, and policy charge is modeled through the published premium-base multiplier formula from the 25th policy month onward.',
