...
export function parseAiaPlatinumWealthLegacy(context: ParseContext) {
  return buildAiaPlatinumWealthProduct(context, {
    ...
    productWarning: 'The parser captures premium-year regular premium charges, the 3% top-up premium charge, the premium-holiday charge schedule, and the published regular-premium partial-withdrawal / surrender charge schedules, while the single-pay corridor, administration charge, insurance risk charge, no-lapse mechanics, and protection-side benefits remain informational only.',
    unsupportedItems: [
