...
export function parseAiaEliteSecureIncome5Pay({ document, sourceChecksumSha256 }: ParseContext): IlpCatalogProduct {
  return {
    ...
    coveredElsewhereBehaviors: ['aia-elite-secure-income-5p-fund-management-charge'],
