...
export function parseTokioMarineGoClassic(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    warnings: [
      ...
      'Loyalty Bonus and Additional Bonus annual qualification and adjustment-factor handling, regular-withdrawal administration, premium-holiday lapse behavior, credit-card charge, dividend payout threshold / record-date handling, and other non-SGD or non-25-year corridors remain informational only.',
