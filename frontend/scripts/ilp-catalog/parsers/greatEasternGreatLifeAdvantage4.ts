...
function buildVariant(document: ExtractedPdfDocument): IlpTemplateVariant {
  ...
  const eventChargeRules: IlpTemplateEventChargeRule[] = [
    ...
    },
    {
      ...
      notes: [
        ...
        'Top-ups are blocked during premium holiday administratively but that gating is not enforced automatically in V1.',
      ],
      sourceRefs: [page10],
    },
    {
  ...
  return {
    ...
    unsupportedItems: [
      ...
      'Child cover, TPD, TI, and other protection-benefit payout handling remain informational only beyond the modeled fee drag.',
    ],
