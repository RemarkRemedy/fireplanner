...
function buildVariant(document: ExtractedPdfDocument): IlpTemplateVariant {
  ...
  return {
    ...
    eecTable: [],
    warnings: [
      'HSBC Life Wealth Invest (CPF) is cataloged as a partial modeled subset in V1. The parser captures the published zero-charge single-premium, approved top-up, and nil-redemption-fee withdrawal path for the CPF corridor through the open-ended no-MIP basis.',
...
export function parseHsbcWealthInvestCpf(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    metadataOnlyBehaviors: [
      ...
      'hsbc-life-wealth-invest-cpf-recurring-single-premium',
    ...
    warnings: [
      'HSBC Life Wealth Invest (CPF) is cataloged as a partial modeled subset in V1. The parser captures the published zero-charge single-premium, approved top-up, and nil-redemption-fee withdrawal path for the CPF corridor through the open-ended no-MIP basis, while protection formulas, recurring-single-premium handling, and fund-level charges remain outside the current engine.',
    ],
    archived: false,
