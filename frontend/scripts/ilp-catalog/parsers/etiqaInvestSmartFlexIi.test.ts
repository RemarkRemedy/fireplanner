...
describe('parseEtiqaInvestSmartFlexIi', () => {
  it('builds a valid partial modeled-subset product from the source PDF', async () => {
    ...
    expect(product.metadataOnlyBehaviors).toContain('etiqa-smart-flex-ii-premium-shortfall-charge')
    expect(product.metadataOnlyBehaviors).toContain('etiqa-smart-flex-ii-insurance-charge')
