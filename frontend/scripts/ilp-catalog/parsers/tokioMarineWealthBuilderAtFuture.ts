...
function buildVariant(document: ExtractedPdfDocument): IlpTemplateVariant {
  ...
  return {
    ...
    unsupportedItems: [
      'Advanced death benefit handling, Life Benefit Rider, monthly protection charge, dividend distribution election, credit-card charge, life-replacement administration, regular withdrawal behavior, minimum-account-value enforcement, and rider premium-deduction handling remain metadata-only for this product.',
    ],
...
export function parseTokioMarineWealthBuilderAtFuture(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    metadataOnlyBehaviors: [
      ...
      'tokio-wealth-builder-atfuture-monthly-protection-charge',
      'tokio-wealth-builder-atfuture-dividend-distribution-election',
    ...
    warnings: [
      ...
      'Wealth Builder@Future is modeled as the SGD / MIP 10 corridor with a published 2.50% policy charge during the minimum investment period and a 0.60% policy charge thereafter.',
