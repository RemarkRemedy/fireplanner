...
export function parseManulifeInvestreadyGrowth(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    warnings: [
      'Manulife InvestReady Growth is cataloged as a supported V1 corridor. The parser captures the accumulated-minimum-premium administrative-charge path, the paid-premium-floor cost-of-insurance formula after you enter insured-life details and current premium bases, the premium-shortfall charge before Flexi Start, the prevailing 5.0% top-up charge, the in-MIP partial-withdrawal and full-surrender charge schedules, and the reinvest-default distribution-mode assumption surface with the published S$40 minimum cash-payout threshold, while bonus mechanics, partial-withdrawal flexibility, benefit payouts, and fund-level charges remain informational only.',
    ],
    archived: false,
    variants: [
