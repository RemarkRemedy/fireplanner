...
function buildVariant(document: ExtractedPdfDocument): IlpTemplateVariant {
  ...
  return {
    ...
    warnings: [
      'AIA Pro Achiever 3.0 is cataloged as a partial modeled subset in V1. The parser models the 10-year IIP corridor: the premium-year regular premium charge schedule, the 5% top-up premium charge, and the regular-premium full-surrender / partial-withdrawal charge schedules.',
      ...
      'Secondary Insured handling, dividend handling, and fund-level charges remain informational only in V1.',
    ],
    unsupportedItems: [
    ...
    sourceRefs: [page1, page2, page5, page8, page10, page11, page14],
  }
}
...
export function parseAiaProAchiever3({ document, sourceChecksumSha256 }: ParseContext): IlpCatalogProduct {
  return {
    ...
    metadataOnlyBehaviors: [
      ...
      'aia-pro-achiever-3-dividend-handling',
      'aia-pro-achiever-3-fund-management-charge',
    ],
    warnings: [
      'AIA Pro Achiever 3.0 is cataloged as a partial modeled subset in V1. The parser models the 10-year IIP premium-charge corridor, 5% top-up premium charge, and the regular-premium withdrawal / surrender charge schedules, while benefit-charge, premium-pass / premium-holiday interactions, premium-reduction mechanics, premium rewards / bonuses, and protection-side options remain outside the current engine.',
    ],
    archived: false,
