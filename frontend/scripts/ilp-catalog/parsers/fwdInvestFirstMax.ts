...
export function parseFwdInvestFirstMax(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    warnings: [
      'FWD Invest First Max is cataloged as a partial modeled subset in V1. The current parser covers the SGD 10-year base-layer corridor: initial-account charge, accumulation-account charge, top-up and recurring-single premium charges, zero redemption fee, and the 10-year surrender-charge schedule.',
      'Bonus units, maturity benefit, increase regular premium layers, and broader premium-flexibility behavior remain outside the current engine.',
    ],
    archived: false,
