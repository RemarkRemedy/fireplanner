...
function buildVariant(document: ExtractedPdfDocument): IlpTemplateVariant {
  ...
  return {
    ...
    accounts: [
      ...
      {
        id: 'topup',
        label: 'Top-up Premium Policy Account',
        feeRate: 0,
        postMipFeeRate: null,
        subjectToEec: false,
        contributionRules: [
    ...
    eecTable: [],
    warnings: [
      'TM Wealth Enhancer (CPFIS) is cataloged as a supported V1 product. The parser captures the published zero-charge single-premium, ad-hoc top-up, regular top-up, and nil-charge withdrawal path for the CPF-funded corridor through the open-ended no-MIP basis, plus the current ordinary death-benefit estimate as 105% of the single premium policy value and 100% of the top-up premium policy value.',
    ...
    unsupportedItems: [
      'Split single-premium and top-up policy-value history remains informational only beyond the modeled current ordinary death-benefit estimate.',
      ...
      'Lapse, termination, and claim-side policy administration remain informational only.',
    ],
...
export function parseTokioMarineWealthEnhancerCpfis(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    warnings: [
      'TM Wealth Enhancer (CPFIS) is cataloged as a supported V1 product. The parser captures the published zero-charge single-premium, ad-hoc top-up, regular top-up, and nil-charge withdrawal path for the CPF-funded corridor through the open-ended no-MIP basis, plus the current ordinary death-benefit estimate as 105% of the single premium policy value and 100% of the top-up premium policy value, while split policy-value history, fund-level charges, switching administration, and lapse / termination handling remain informational only.',
    ],
    archived: false,
