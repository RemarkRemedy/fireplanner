...
describe('parseAiaEliteSecureIncomeSp', () => {
  it('builds a valid payout-state supported product from extracted summary text', async () => {
    ...
    expect(variant.unsupportedItems).toContain('Once Secure Monthly Income can already have been paid or deemed paid, payout erosion still needs a manual current net protected premium base input in V1.')
