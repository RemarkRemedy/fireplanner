  ...
  return {
    ...
    distributionSupport: {
      ...
      notes: [
        ...
        'V1 seeds reinvestment by default; cash payout requires a manual annual distribution-yield assumption, and payouts below the published S$30 minimum annual threshold remain reinvested while designated-bank-account routing remains informational only.',
      ],
      sourceRefs: [page8],
    },
    policyStateSupport: {
