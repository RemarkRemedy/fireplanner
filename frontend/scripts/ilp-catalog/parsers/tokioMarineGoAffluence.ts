...
function buildVariant(document: ExtractedPdfDocument): IlpTemplateVariant {
  ...
  return {
    ...
    warnings: [
      ...
      'This partial template models regular-premium routing through the 15-year payment term, the published initial bonus tiers, the year-scaled initial charge schedule, the policy charge premium-base multiplier basis, top-up routing, recurring single premium routing, and the published 15-year surrender charge table.',
    ...
    unsupportedItems: [
      ...
      'Dividend distribution election, regular withdrawal, partial-withdrawal limit and minimum-account-value constraints, premium holiday state handling, and non-SGD/premium-term variants remain metadata-only for this product.',
    ],
...
export function parseTokioMarineGoAffluence(context: ParseContext): IlpCatalogProduct {
  return {
    ...
    metadataOnlyBehaviors: [
      ...
      'tokio-goaffluence-dividend-distribution-regular-withdrawal-and-partial-withdrawal-constraints',
    ...
    warnings: [
      ...
      'Initial charge is modeled through the published year-scaled account-value fee schedule on the Initial Units Account, and policy charge is modeled through the published premium-base multiplier formula.',
